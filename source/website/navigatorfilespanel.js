...
export class NavigatorFilesPanel extends NavigatorPanel
{
    ...
    Fill (importResult)
    {
        ...
        if (missingFiles.length > 0) {
            let missingFilesItem = new TreeViewGroupItem (localize('missingFiles', 'Missing Files'), null);
            ...
            let filesItem = new TreeViewGroupItem (localize('availableFiles', 'Available Files'), null);
